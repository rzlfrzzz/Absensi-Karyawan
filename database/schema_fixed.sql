...
-- FIXED VERSION - No generated columns issues
...
CREATE POLICY "Users - Public update" ON users
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Users - Public delete" ON users
  FOR DELETE USING (TRUE);

-- Karyawan: Everyone can access
CREATE POLICY "Karyawan - Public read" ON karyawan
  FOR SELECT USING (TRUE);

CREATE POLICY "Karyawan - Public insert" ON karyawan
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Karyawan - Public update" ON karyawan
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Karyawan - Public delete" ON karyawan
  FOR DELETE USING (TRUE);

-- Logs: Everyone can access
...
CREATE POLICY "Logs - Public update" ON logs_absensi
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Logs - Public delete" ON logs_absensi
  FOR DELETE USING (TRUE);

-- Shift settings: Everyone can access
CREATE POLICY "Shift settings - Public read" ON shift_settings
  FOR SELECT USING (TRUE);

CREATE POLICY "Shift settings - Public insert" ON shift_settings
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Shift settings - Public update" ON shift_settings
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Shift settings - Public delete" ON shift_settings
  FOR DELETE USING (TRUE);

-- Gaji: Everyone can access
CREATE POLICY "Gaji settings - Public read" ON gaji_settings
  FOR SELECT USING (TRUE);

CREATE POLICY "Gaji settings - Public insert" ON gaji_settings
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Gaji settings - Public update" ON gaji_settings
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Gaji settings - Public delete" ON gaji_settings
  FOR DELETE USING (TRUE);

-- Bonus: Everyone can access
CREATE POLICY "Bonus rules - Public read" ON bonus_rules
  FOR SELECT USING (TRUE);

CREATE POLICY "Bonus rules - Public insert" ON bonus_rules
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Bonus rules - Public update" ON bonus_rules
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Bonus rules - Public delete" ON bonus_rules
  FOR DELETE USING (TRUE);

-- Deduction: Everyone can access
CREATE POLICY "Deduction rules - Public read" ON deduction_rules
  FOR SELECT USING (TRUE);

CREATE POLICY "Deduction rules - Public insert" ON deduction_rules
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Deduction rules - Public update" ON deduction_rules
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Deduction rules - Public delete" ON deduction_rules
  FOR DELETE USING (TRUE);

-- Holiday: Everyone can access
CREATE POLICY "Holiday - Public read" ON holiday_calendar
  FOR SELECT USING (TRUE);

CREATE POLICY "Holiday - Public insert" ON holiday_calendar
  FOR INSERT WITH CHECK (TRUE);

CREATE POLICY "Holiday - Public update" ON holiday_calendar
  FOR UPDATE USING (TRUE) WITH CHECK (TRUE);

CREATE POLICY "Holiday - Public delete" ON holiday_calendar
  FOR DELETE USING (TRUE);
